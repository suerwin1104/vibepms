...
const ChartOfAccounts: React.FC<ChartOfAccountsProps> = ({
    ...
    return (
        <div>
            ...
            {/* Add Form (Only show at top when adding new) */}
            {isAdding && !editingId && (
                <div style={{
                        ...
                        {filteredAccounts.length === 0 ? (
                            ...
                            filteredAccounts.map(account => (
                                <React.Fragment key={account.id}>
                                    <tr style={{ borderBottom: '1px solid #f1f5f9', backgroundColor: editingId === account.id ? '#eff6ff' : 'transparent' }}>
                                            ...
                                            <td colSpan={7} style={{ padding: '0', backgroundColor: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
                                                <div style={{ padding: '24px', borderLeft: '4px solid #3b82f6' }}>
                                                    <h4 style={{ margin: '0 0 16px 0', fontSize: '16px', fontWeight: 600, color: '#334155' }}>
                                                        ✏️ 編輯: {account.code} {account.name}
                                                    </h4>
                                                    <form onSubmit={handleSubmit}>
                                                        {renderFormFields()}
                                                    </form>
